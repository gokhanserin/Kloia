 ...
 */
    ...
    /*
    Create a re-usable utility method that will return same driver instance when we call it
     */
    ...
    public static WebDriver getDriver(){
        ...
        if (driverPool.get()==null){
            ...
            /*
            Depending on the browser type that will be return from configuration.properties file
